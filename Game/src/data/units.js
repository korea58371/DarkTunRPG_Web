export const UNITS = {
  'C-001': { id:'C-001', name:'주인공', hp:55, hpMax:55, mp:30, spd:7, atk:18, def:4, shield:0, crit:0.185, dodge:0.05, block:0.165, position:1, skills:['SK-01','SK-03','SK-31','SK-32','SK-MOVE-1','SK-11','SK-13'] },
  ...
  'C-015': { id:'C-015', name:'헬레나(화염술사)', hp:24, hpMax:24, mp:20, spd:5, atk:6, mag:16, def:1, shield:0, crit:0.08, dodge:0.06, block:0.02, position:3, skills:['SK-FIREBALL','SK-FIRE-CROSS','SK-MOVE-1'], preferredRows:[3,2,1] },
  ...
  'C-050': { id:'C-050', name:'세리아', hp:20, hpMax:20, mp:18, spd:5, atk:3, mag:12, def:1, shield:0, crit:0.05, dodge:0.06, block:0.02, position:3, skills:['SK-20','SK-21','SK-30'], preferredRows:[3,2,1] },
  ...
  ,
  'E-301': { id:'E-301', name:'사나운 늑대', hp:12, hpMax:12, mp:0, spd:8, atk:10, def:0, shield:0, crit:0.12, dodge:0.10, block:0.00, position:7, skills:['SK-10'], passives:['PS-AGILE'], deathLine:'낑—', preferredRows:[1,2,3] }
};
