export const ROUTES = [
  ...
  // 패배 분기: BT-200에서 패배했을 때만 열림
  { id:'R-205', title:'패배의 선택', summary:'동료를 버리고 도망칠 것인가, 내가 방패가 될 것인가', requirements:[{type:'flag', key:'bt.BT-200.win', value:false}], next:'EP-205', branches:[
    { to:'R-210', label:'제물로 바치고 도망' },
    { to:'R-220', label:'내가 방패가 된다' }
  ] },
