export const EPISODES = {
  ...
  'EP-900': {
    scene: [
      { speaker:'나레이션', text:'거대 해골 보스를 처치하자, 밝은 빛과 함께 포탈이 생성된다.' },
      { speaker:'나레이션', text:'직감적으로 현실로 돌아갈 수 있는 포탈이라고 느낀다.' },
      { speaker:'나레이션', text:'살아남은 이들과 마지막 인사를 하고, 현실로 향한다.' }
    ],
    choices: [ { label:'End01: 현실로', effects:[{type:'flag.set', key:'game.ending', value:'END01'}], next:'END-01' } ]
  }
};
