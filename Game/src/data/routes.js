export const ROUTES = [
  ...
  { id:'R-100', title:'늑대 전투', summary:'늑대와 1:1 전투', requirements:[], next:'BT-100', branches:[{"to":"R-101","label":"진행"}] },
  { id:'R-101', title:'첫 동료 만남', summary:'새로운 동료가 합류', requirements:[{"type":"flag","key":"__custom__","value":true}], next:'EP-101', branches:[{"to":"R-200","label":"함께 나아간다"}] },
  ...
  { id:'R-300', title:'세리아와의 만남', summary:'치유사 세리아와 조우', requirements:[{"anyOf":[{"type":"flag","key":"__custom__","value":true},{"type":"flag","key":"","value":true},{"type":"flag","key":"__custom__","value":true}]}], next:'EP-300', branches:[{"to":"R-400","label":"함께 한다"}] },
