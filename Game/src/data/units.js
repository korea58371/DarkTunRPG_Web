export const UNITS = {
  'C-001': { id:'C-001', name:'주인공', hp:35, hpMax:35, mp:10, spd:7, atk:8, def:4, shield:0, crit:0.185, dodge:0.05, block:0.165, position:1, skills:['SK-01','SK-03','SK-11','SK-13'] },
  'C-014': { id:'C-014', name:'동료A', hp:22, hpMax:22, mp:12, spd:6, atk:6, def:1, shield:0, crit:0.1, dodge:0.08, block:0.04, position:2, skills:['SK-01','SK-02','SK-12','SK-22'], deathLine:'크으... 여기까지인가.. 뒤는 부탁한다..', preferredRows:[3,2,1] },
