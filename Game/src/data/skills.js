...
export const SKILLS = {
  'SK-01': { id:'SK-01', name:'베기', range:'melee', type:'strike', hits:1, acc:1, accAdd:0, coeff:1, cost:{mp:0}, damageType:'slash', upgrades:[{ id:'SK01_ROW', name:'일열 공격', desc:'공격 범위가 전열 전체로 변경(1회 선택) 대미지 감소', type:'once', effects:[{ path:'type', op:'set', value:"line" }, { path:'to', op:'set', value:[1] }] }, { id:'SK01_DMG30', name:'대미지 +30%', desc:'스킬 대미지 30% 증가(중첩 가능)', type:'stack', effects:[{ path:'coeff', op:'mul', value:1.3 }] }, { id:'SK01_BLEED', name:'적중 시 출혈', desc:'적중 시 3턴 출혈 효과 (1회 선택)', type:'once', effects:[{ path:'bleed', op:'set', value:{"chance":0.5,"duration":3,"coeff":0.3} }] }] },
